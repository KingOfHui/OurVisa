...
import com.eshel.ourvisa.util.MD5Utils;
...
public class MD5 {
    ...
    public static String sign(String text, String key, String input_charset) {
    	text = text + key;
        return MD5Utils.encode(text, input_charset);
    }
    ...
    public static boolean verify(String text, String sign, String key, String input_charset) {
    	text = text + key;
    	String mysign = MD5Utils.encode(text, input_charset);
     ...
     * @return 返回签名后的字符串
     */
    public static <Json extends BaseBean>String signJson(Json json, String key){
    	if(json == null){
    		return null;
    	}

        JSONObject object = JSONObject.parseObject(JSON.toJSONString(json));
        /*Gson gson = VisaApp.getContext().getConfig().getGson();
        String dataJ = gson.toJson(json, json.getClass());
        Type type = new TypeToken<Map<String, Object>>() {}.getType();
        Map<String, Object> jsonMap = gson.fromJson(dataJ, type);*/

    	//过滤空值、sign与sign_type参数
    	Map<String, String> sParaNew = paraFilter(object);
    	
        //获取待签名字符串
        String preSignStr = createLinkString(sParaNew);
        
    	return MD5.sign(preSignStr, key, Constant.UTF_8);
    }
	...
	public static boolean getMd5SignVeryfy(Map<String, Object> Params, String sign, String md5Key) {
        ...
        String preSignStr = createLinkString(sParaNew);
        //获得签名验证结果
        return MD5.verify(preSignStr, sign, md5Key, Constant.UTF_8);
    }
